AS3AP can send dashboard and chart to specified mail box as report email by following user configurations. Please configure Email [Notification](notification) correctly before start to use report feature.
